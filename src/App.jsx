      ...
      <div>
        ...
        <Row>
          ...
          <Col lg={4} sm={12}>
            ...
            <Button  onClick={checkBMI}  style={{ marginLeft: '40%', marginTop: '30px' }}  variant="primary"  >Check BMI</Button>
              ...
              <div style={{ marginTop: '50px' }}>
                {bmiCategory === "Normal" && (
                  <Card style={{ width: '100%' }}>
                    <Card.Body>
                      <Card.Title
                        style={{  display: 'flex',  justifyContent: 'center',  textAlign: 'center',  color: 'green',  fontWeight: '600',  }} >Healthy</Card.Title>
...
<Card.Body>
  <Card.Title
    style={{  display: 'flex',  justifyContent: 'center',  textAlign: 'center',  color: 'red',  fontWeight: '600',  }} >Underweight</Card.Title>
...
<Card.Body>
  <Card.Title
    style={{  display: 'flex',  justifyContent: 'center',  textAlign: 'center',  color: 'red',  fontWeight: '600',  }} >Overweight</Card.Title>
  <Card.Text style={{ color: 'red' }}>
...
<Card.Body>
  <Card.Title
    style={{  display: 'flex',  justifyContent: 'center',  textAlign: 'center',  color: 'red',  fontWeight: '600',  }} >Obesity</Card.Title>
  <Card.Text style={{ color: 'red' }}>
